<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Project1SchoolRegister.Register" %>
                        ...
                        <ul class="menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="Index.aspx" class="drop-text">Fotoğraflar</a></li>
                                </ul>
                            </li>
            ...
            <div class="modal-body mt-md-2 mt-5">
                ...
                <form action="#" method="post" runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control" placeholder="loremipsum@email.com"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">Şehir</label>
                        <asp:TextBox ID="TextBox3" runat="server" CssClass="form-control" placeholder="Şehir Giriniz"></asp:TextBox>                  
                    </div>
                    <div class="form-group">
                    ...
                    <div class="sub-w3l my-3">
                        <div class="sub-w3layouts_hub">
                            ...
                            <label for="brand1" class="text-li text-style-w3ls">
                                <span></span>Tüm koşullları kabul ediyorum</label>
                        </div>
                    </div>
                    
                    <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" Text="Giriş" OnClick="Button1_Click" Width="182px" />
                </form>
            ...
            <div class="row footer-grids">
                <div class="col-lg-2 col-6 footer-grid">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <a href="Index.aspx">Hakkımızda</a>
                        </li>
                        <li>
                            <a href="Index.aspx">Ne yapıyoruz?</a>
                        </li>
                        <li>
                            <a href="Index.aspx">Fotoğraflar</a>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-2 col-6 footer-grid">
